...
struct CSFString:public ForwardNode<CSFString>
{
	wchar_t Text[102];

	CSFString() : ForwardNode<CSFString>() {
		*Text = 0;
	}
};
...
{
public:
	static constexpr reference<ForwardList<CSFString>, 0xB1CF88u> const LastLoadedString{};
	static constexpr reference<ForwardList<CSFString>, 0xB1CF8Cu> const MissingString;
